...
# RUN IN POWERSHELL
dotnet publish -r win-x64 -c Release -p:SelfContained=True -p:IncludeAllContentForSelfExtract=True -p:PublishSingleFile=True -o bin/Release/net10.0/publishWin
cd "$ORIGIN"

APP_NAME="Amplitude Soundboard"
APP_OUTPUT_PATH="Build"
PUBLISH_OUTPUT_DIRECTORY="../../bin/Release/net10.0/publishWin/."
